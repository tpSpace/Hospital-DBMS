        ...
        <div>
            <div className='py-4'>
                { appointments.length > 0 ? (
                    <div>
                        <h2 className="text-center m-4">There are {appointments.length} appointments</h2>
                        <br></br>
            ...
            <div>
                { doctors.length > 0 ? (
                    <div>
                        <h2 className="text-center m-4">There are {doctors.length} doctors under management</h2>
                        <br></br>
                        <table className="table border shadow">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                {
                                    doctors.map((doctor, index) => (
                                        <tr key={index}>
                                            ...
                                            <button onClick={() => handleEdit('Doctor', doctor.doctorId)}>Edit</button>
                                        </tr>
                                    ))
                                }
                            </tbody>
            ...
            <div>
                { patients.length > 0 ? (
                    <div>
                        <h2 className="text-center m-4">There are {patients.length} patients under management</h2>
                        <br></br>
                        <table className="table border shadow">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                {
                                    patients.map((patient, index) => (
                                        <tr key={index}>
                                            ...
                                            <button onClick={() => handleEdit('Patient', patient.patientId)}>Edit</button>
                                        </tr>
                                    ))
                                }
                            </tbody>
            ...
            <div>
                { nurses.length > 0 ? (
                    <div>
                        <h2 className="text-center m-4">There are {nurses.length} nurses under management</h2>
                        <br></br>
                        <table className="table border shadow">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                {
                                    nurses.map((nurse, index) => (
                                        <tr key={index}>
                                            ...
                                            <button onClick={() => handleEdit('Nurse', nurse.nurseId)}>Edit</button>
                                        </tr>
                                    ))
                                }
                            </tbody>
